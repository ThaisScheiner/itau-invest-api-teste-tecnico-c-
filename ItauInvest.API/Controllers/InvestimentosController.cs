...
namespace ItauInvest.API.Controllers
{
    ...
    public class InvestimentosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Posicao>> GetPosicao(long usuarioId, long ativoId)
        {
            ...
            if (posicao == null)
            {
                return NotFound($"Nenhuma posição encontrada para o usuário {usuarioId} com o ativo {ativoId}.");
            }
        ...
        public async Task<ActionResult<List<(long usuarioId, decimal valorTotal)>>> GetTop10ClientesPorPosicao()
        {
        ...
        public async Task<ActionResult<List<(long usuarioId, decimal totalCorretagem)>>> GetTop10ClientesPorCorretagem()
        {
        ...
        public async Task<IActionResult> CriarOperacao([FromBody] Operacao novaOperacao)
        {
            ...
            // Simula o que o worker faria: recalcular a posição imediatamente.
